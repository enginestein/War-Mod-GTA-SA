...
:WAR_2
wait 0
model.Load(3174) // house car
model.Load(12957) // junk car
model.Load(1440) // box pile
model.Load(3092) // corpse
model.Load(16444) // body bags
model.Load(964) // army crate 
model.Load(3098) // destroyed pile
model.Load(944) // box
model.Load(3066) // barrier
038B: load_requested_models
if and
model.Available(3174)
model.Available(12957)
model.Available(964) 
model.Available(3098) 
jf @WAR_2
if and
model.Available(944) 
model.Available(3066)
model.Available(1440) 
model.Available(3092)
model.Available(16444)
jf @WAR_2 
29@ = 0
31@ = 0  
30@ = 0
