...
jf @WAR_800
1@(30@,10i) = actor.Create(Gang1, 287, 21@, 22@, 23@)
...
23@ += 5.0
02CE: 23@ = ground_z_at 21@ 22@ 23@
05D3: AS_actor 1@(30@,10i) goto_point 21@ 22@ 23@ mode 6 time -1 ms
jump @WAR_800
...
jf @WAR_900
11@(31@,10i) = actor.Create(Gang2, 285, 21@, 22@, 23@)
...
23@ += 5.0
02CE: 23@ = ground_z_at 21@ 22@ 23@
05D3: AS_actor 11@(31@,10i) goto_point 21@ 22@ 23@ mode 6 time -1 ms 
jump @WAR_900
