...
26@ = 0
if
0AAB:   file_exists "CLEO/war_sounds.mp3"
jf @WAR_110
30@ = audiostream.Load("CLEO/war_sounds.mp3")

:WAR_110
0AAB:   file_exists "CLEO/siren.mp3"
jf @WAR_200
31@ = audiostream.Load("CLEO/siren.mp3")
...
jf @WAR_200
04C4: store_coords_to 3@ 4@ 5@ from_actor $PLAYER_ACTOR with_offset 14@ 250.0 35.0
00A5: 0@ = create_car #RUSTLER at 3@ 4@ 5@
...
object.Create(19@, #GRENADE, 0.0, 0.0, 0.0)
