...
jf @WAR_400
00A5: 0@ = create_car #PATRIOT at 21@ 22@ 23@
actor.Create(2@, Gang1, #ARMY, 0.0, 0.0, 0.0)
actor.GiveWeaponAndAmmo(2@, 30, 9999)
actor.Create(4@, Gang1, #ARMY, 0.0, 0.0, 0.0)
...
0129: 1@ = create_actor_pedtype 7 model #ARMY in_car 0@ driverseat
04C4: store_coords_to 21@ 22@ 23@ from_actor $PLAYER_ACTOR with_offset 21@ 22@ 0.0
...
00EC:   actor $PLAYER_ACTOR sphere 0 near_point 21@ 22@ radius 150.0 150.0
jf @WAR_510
00A5: 10@ = create_car #PATRIOT at 21@ 22@ 23@
actor.Create(12@, Gang2, #SWAT, 0.0, 0.0, 0.0)
actor.GiveWeaponAndAmmo(12@, 30, 9999)
actor.Create(14@, Gang2, #SWAT, 0.0, 0.0, 0.0)
...
0812: AS_actor 14@ perform_animation "camstnd_idleloop" IFP "Camera" framedelta 4.0 loopA 1 lockX 0 lockY 0 lockF 0 time -1 // versionB
0208: 21@ = random_float_in_ranges -15.0 15.0
0208: 22@ = random_float_in_ranges -15.0 15.0
0129: 11@ = create_actor_pedtype 8 model #SWAT in_car 10@ driverseat
04C4: store_coords_to 21@ 22@ 23@ from_actor $PLAYER_ACTOR with_offset 21@ 22@ 0.0
...
00EC:   actor $PLAYER_ACTOR sphere 0 near_point 21@ 22@ radius 150.0 150.0
jf @WAR_600
00A5: 5@ = create_car #PATRIOT at 21@ 22@ 23@
actor.Create(8@, Gang1, #ARMY, 0.0, 0.0, 0.0)
actor.GiveWeaponAndAmmo(8@, 30, 9999)
actor.Create(9@, Gang1, #ARMY, 0.0, 0.0, 0.0)
...
0208: 21@ = random_float_in_ranges -15.0 15.0
0208: 22@ = random_float_in_ranges -15.0 15.0
0129: 7@ = create_actor_pedtype 7 model #ARMY in_car 5@ driverseat
04C4: store_coords_to 21@ 22@ 23@ from_actor $PLAYER_ACTOR with_offset 21@ 22@ 0.0
