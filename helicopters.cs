...
2@ = actor.Create(gang1, #SWAT, 3@, 4@, 5@)
...
:WAR_350
04C4: store_coords_to 3@ 4@ 5@ from_actor $PLAYER_ACTOR with_offset 14@ 150.0 70.0
00A5: 0@ = create_car #SPARROW at 3@ 4@ 5@
0129: 1@ = create_actor_pedtype 7 model #ARMY in_car 0@ driverseat
0825: set_helicopter 0@ instant_rotor_start
2@ = actor.Create(gang1, #ARMY, 3@, 4@, 5@)
...
12@ = actor.Create(gang2, #SWAT, 3@, 4@, 5@)
...
:WAR_550
04C4: store_coords_to 3@ 4@ 5@ from_actor $PLAYER_ACTOR with_offset 14@ -150.0 70.0
00A5: 10@ = create_car #SPARROW at 3@ 4@ 5@
0129: 11@ = create_actor_pedtype 8 model #SWAT in_car 10@ driverseat
0825: set_helicopter 10@ instant_rotor_start
12@ = actor.Create(gang2, #SWAT, 3@, 4@, 5@)
